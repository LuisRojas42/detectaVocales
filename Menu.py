...
A_files_H = ['./resources/AR.wav', './resources/A-L.wav', './resources/AI.wav']
E_files_H = ['./resources/ER.wav', './resources/E-L.wav', './resources/EI.wav']
I_files_H = ['./resources/I-R.wav', './resources/I-L.wav', './resources/II.wav']
O_files_H = ['./resources/O-R.wav', './resources/O-L.wav', './resources/OI.wav']
U_files_H = ['./resources/UR.wav', './resources/U-L.wav', './resources/UI.wav']


A_files_M = ['./resources/A-M.wav', './resources/AS.wav']
E_files_M = ['./resources/E-M.wav', './resources/ES.wav']
I_files_M = ['./resources/I-M.wav', './resources/IS.wav']
O_files_M = ['./resources/O-M.wav']
U_files_M = ['./resources/U-M.wav', './resources/US.wav']
...
class Menu():
    ...
    def __init__(self):
        ...
        miImagen = PhotoImage(file='./resources/back2.png')
